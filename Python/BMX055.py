...
bus.write_byte_data(0x18, 0x11, 0x00)
...
bus.write_byte_data(0x68, 0x0F, 0x04)
# BMX055 Gyro address, 0x68(104)
# Select Bandwidth register, 0x10(16)
#		0x07(07)	ODR = 100 Hz
bus.write_byte_data(0x68, 0x10, 0x07)
# BMX055 Gyro address, 0x68(104)
# Select LPM1 register, 0x11(17)
#		0x00(00)	Normal mode, Sleep duration = 2ms
bus.write_byte_data(0x68, 0x11, 0x00)
...
data = bus.read_i2c_block_data(0x10, 0x42, 6)
